...
document.querySelector("button").addEventListener("click", function () { //lets the player click a button instead of refreshing the page.
    ...
    document.querySelectorAll("img")[0].setAttribute("src", 'DiceGame/images/dice'+randomNumber1.toString()+'.png');
    document.querySelectorAll("img")[1].setAttribute("src", 'DiceGame/images/dice'+randomNumber2.toString()+'.png');
